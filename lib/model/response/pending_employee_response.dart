...
class PendingEmployeeResponse {
  ...
  factory PendingEmployeeResponse.fromJson(json) {
    return PendingEmployeeResponse(
        json["BEAT_NAME"]??'',
  ...
  static List<PendingEmployeeResponse> getLast15DaysList(List<PendingEmployeeResponse> inputlist) {
    List<PendingEmployeeResponse> outputList =
    inputlist.where((PendingEmployeeResponse element) {
      try {
        final date =
  ...
  static List<PendingEmployeeResponse> getLast15To30DaysList(List<PendingEmployeeResponse> inputlist) {
    List<PendingEmployeeResponse> outputList =
    inputlist.where((PendingEmployeeResponse element) {
      try {
        final date =
  ...
  static List<PendingEmployeeResponse> getBefore30DaysList(
      List<PendingEmployeeResponse> inputlist) {
    List<PendingEmployeeResponse> outputList =
    inputlist.where((PendingEmployeeResponse element) {
      try {
        final date =
  ...
  static List<PendingEmployeeResponse> getDataFromToDateList(String fDate,String tDate,List<PendingEmployeeResponse> inputlist) {
    List<PendingEmployeeResponse> outputList = inputlist.where((PendingEmployeeResponse element) {
      try {
  ...
  static Future<void> generateExcel(
      context, List<PendingEmployeeResponse> lst) async {
    if (lst.isNotEmpty) {
