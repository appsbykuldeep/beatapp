...
class CompletedEmployeeConsResponse {
  ...
  factory CompletedEmployeeConsResponse.fromJson(Map<String, dynamic> json) {
    return CompletedEmployeeConsResponse(
        json["BEAT_NAME"]??'',
  ...
  static List<CompletedEmployeeConsResponse> getLast15DaysList(
      List<CompletedEmployeeConsResponse> inputlist) {
    List<CompletedEmployeeConsResponse> outputList =
    inputlist.where((CompletedEmployeeConsResponse element) {
      try {
        final date =
  ...
  static List<CompletedEmployeeConsResponse> getLast15To30DaysList(
      List<CompletedEmployeeConsResponse> inputlist) {
    List<CompletedEmployeeConsResponse> outputList =
    inputlist.where((CompletedEmployeeConsResponse element) {
      try {
  ...
  static List<CompletedEmployeeConsResponse> getBefore30DaysList(
      List<CompletedEmployeeConsResponse> inputlist) {
    List<CompletedEmployeeConsResponse> outputList =
    inputlist.where((CompletedEmployeeConsResponse element) {
      try {
  ...
  static List<CompletedEmployeeConsResponse> getDataFromToDateList(String fDate,String tDate,List<CompletedEmployeeConsResponse> inputlist) {
    List<CompletedEmployeeConsResponse> outputList = inputlist.where((CompletedEmployeeConsResponse element) {
      try {
  ...
  static Future<void> generateExcel(
      context, List<CompletedEmployeeConsResponse> lst) async {
    if (lst.isNotEmpty) {
      ...
      for (int i = 0; i < lst.length; i++) {
        ...
        sheet.getRangeByIndex(i+2, 6).setText(("").toString());
