class DomesticVerificationDetail {
  ...
  DomesticVerificationDetail(this.dOMESTICSRNUM,
      this.sERVANTSRNUM,
      this.aPPLICATIONDT,
      this.rEQUESTERNAME,
      this.rELATIONTYPE,
  ...
  factory DomesticVerificationDetail.fromJson(json){
    return DomesticVerificationDetail(
        json["DOMESTIC_SR_NUM"].toString(),
        json["SERVANT_SR_NUM"].toString(),
        json["APPLICATION_DT"],
        json["REQUESTER_NAME"],
        json["RELATIONTYPE"],
        json["RELATIVE_NAME"],
  ...
  factory DomesticVerificationDetail.emptyData() {
    return DomesticVerificationDetail(
        null,
        null,
        null,
