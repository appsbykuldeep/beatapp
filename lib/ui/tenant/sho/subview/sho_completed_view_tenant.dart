...
class ShoCompletedFragmentTenant extends StatefulWidget {
  const ShoCompletedFragmentTenant({Key? key}) : super(key: key);

  @override
  State<ShoCompletedFragmentTenant> createState() =>
      _ShoCompletedFragmentTenantState();
}

class _ShoCompletedFragmentTenantState
    extends State<ShoCompletedFragmentTenant> {
  ...
  void _getTenantVerificationList() async {
    ...
    var response = await HttpRequst.postRequestWithTokenAndBody(
        context, EndPoints.COMPLETED_TENANT_LIST_SHO, data, true);
