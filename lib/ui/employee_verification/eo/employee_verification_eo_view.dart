...
class EmployeeVerificationEoActivity extends StatefulWidget {
  const EmployeeVerificationEoActivity({Key? key}) : super(key: key);

  @override
  State<EmployeeVerificationEoActivity> createState() =>
      _EmployeeVerificationEoActivityState();
}

class _EmployeeVerificationEoActivityState
    extends BaseFullState<EmployeeVerificationEoActivity> {
