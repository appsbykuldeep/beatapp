...
class PendingFragmentEmployeeEo extends StatefulWidget {
  const PendingFragmentEmployeeEo({Key? key}) : super(key: key);

  @override
  State<PendingFragmentEmployeeEo> createState() =>
      _PendingFragmentEmployeeEoState();
}

class _PendingFragmentEmployeeEoState
    extends BaseFullState<PendingFragmentEmployeeEo> {
  ...
  void _getEmpVerList() async {
    var userData = await LoginResponseModel.fromPreference();
    var data = {"PS_CD": userData.psCd, "SERVICE_TYPE": "3"};
