...
class ShoCompletedFragmentEmployee extends StatefulWidget {
  const ShoCompletedFragmentEmployee({Key? key}) : super(key: key);

  @override
  State<ShoCompletedFragmentEmployee> createState() =>
      _ShoCompletedFragmentEmployeeState();
}

class _ShoCompletedFragmentEmployeeState
    extends State<ShoCompletedFragmentEmployee> {
  List<CompletedEmployeeResponse> _lstData = [];
  final List<CompletedEmployeeResponse> _lstDataAll = [];
  ...
  void _getEmployeeVerificationList() async {
    ...
    var response = await HttpRequst.postRequestWithTokenAndBody(
        context, EndPoints.COMPLETED_EMPLOYEE_LIST_SHO, data, true);
