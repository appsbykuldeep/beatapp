...
class PendingFragmentEmployee extends StatefulWidget {
  const PendingFragmentEmployee({Key? key}) : super(key: key);

  @override
  State<PendingFragmentEmployee> createState() =>
      _PendingFragmentEmployeeState();
}

class _PendingFragmentEmployeeState extends State<PendingFragmentEmployee> {
  List<PendingEmployeeResponse> _lstData = [];
  final List<PendingEmployeeResponse> _lstDataAll = [];
  ...
  void _getEmployeeVerificationList() async {
    ...
    var response = await HttpRequst.postRequestWithTokenAndBody(
        context, EndPoints.END_POINT_ASSIGNED_EMPLOYEE_LIST, data, true);
