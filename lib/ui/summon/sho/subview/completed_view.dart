...
class _CompletedFragmentState extends State<CompletedFragment> {
  ...
  void _getUnAssignedList() async {
    ...
    response = await HttpRequst.postRequestWithTokenAndBody(
        context, EndPoints.COMPLETED_SUMMON, data, true);
              ...
              InkWell(
                onTap: () {
                  SummonResponse.generateExcel(
                      context, _lstSummon, "CompletedSummon");
                },
                child: Container(
                  alignment: Alignment.center,
          ...
          children: [
            Container(
              ...
              child: Row(
                children: [
                  Expanded(
                    child: Text(getTranlateString("fir_patty_case_no"),
                        style: getHeaderStyle()),
                    flex: 1,
                  ),
                    Expanded(
                      child: Text(data.FIR_REG_NUM ?? ""),
                      flex: 1,
                    )
                  ],
                ),
              ...
              Container(
                ...
                child: Row(
                  children: [
                    Expanded(
                      child: Text(getTranlateString("beat_person_name"),
                          style: getHeaderStyle()),
                      flex: 1,
                    ),
                    Expanded(
                      child: Text(data.ASSIGNED_TO_NAME ?? ""),
                      flex: 1,
                    )
                  ],
                ),
              ...
              Container(
                ...
                child: Row(
                  children: [
                    ...
                    Expanded(
                      child: Text(data.ASSIGNED_TO_RANK ?? ""),
                      flex: 1,
                    )
                  ],
                ),
              ...
              Container(
                ...
                child: Row(
                  children: [
                    ...
                    Expanded(
                      child: Text(data.COMPLETION_DATE ?? ""),
                      flex: 1,
                    )
                  ],
                ),
