...
class DomesticVerificationEoActivity extends StatefulWidget {
  const DomesticVerificationEoActivity({Key? key}) : super(key: key);

  @override
  State<DomesticVerificationEoActivity> createState() =>
      _DomesticVerificationEoActivityState();
}

class _DomesticVerificationEoActivityState
    extends BaseFullState<DomesticVerificationEoActivity> {
