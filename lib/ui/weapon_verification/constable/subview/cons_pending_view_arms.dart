...
import 'package:beatapp/ui/weapon_verification/constable/weapon_verificationd_detail_submit_view.dart';
...
class ConsPendingFragmentArms extends StatefulWidget {
  const ConsPendingFragmentArms({Key? key}) : super(key: key);

  @override
  State<ConsPendingFragmentArms> createState() =>
      _ConsPendingFragmentArmsState();
}

class _ConsPendingFragmentArmsState
    extends BaseFullState<ConsPendingFragmentArms> {
  List<WeaponDetail_Table> _lstData = [];
    ...
    return InkWell(
      onTap: () async {
        bool res = await Navigator.push(
            context,
            MaterialPageRoute(
              builder: (context) => WeaponVerificationdDetailSubmitActivity(
