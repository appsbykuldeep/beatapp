...
class PendingFragmentHistorySheeters extends StatefulWidget {
  const PendingFragmentHistorySheeters({Key? key}) : super(key: key);

  @override
  State<PendingFragmentHistorySheeters> createState() =>
      _PendingFragmentHistorySheetersState();
}

class _PendingFragmentHistorySheetersState
    extends BaseFullState<PendingFragmentHistorySheeters> {
  List<HistorySheetersDetailsResponse> _lstData = [];
  final List<HistorySheetersDetailsResponse> _lstDataAll = [];
