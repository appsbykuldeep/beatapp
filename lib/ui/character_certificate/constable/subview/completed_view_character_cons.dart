...
class CompletedFragmentCharacterCons extends StatefulWidget {
  const CompletedFragmentCharacterCons({Key? key}) : super(key: key);

  @override
  State<CompletedFragmentCharacterCons> createState() =>
      _CompletedFragmentCharacterConsState();
}

class _CompletedFragmentCharacterConsState
    extends BaseFullState<CompletedFragmentCharacterCons> {
  ...
  void _getCharacterCertList() async {
    ...
    var response = await HttpRequst.postRequestWithTokenAndBody(context,
        EndPoints.END_POINT_GET_COMPLETED_CHARACTER_LIST_BEAT, data, true);
