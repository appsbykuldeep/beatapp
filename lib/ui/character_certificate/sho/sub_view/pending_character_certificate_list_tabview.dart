...
class PendingCharacterCertificateListFragment extends StatefulWidget {
  const PendingCharacterCertificateListFragment({Key? key}) : super(key: key);

  @override
  State<PendingCharacterCertificateListFragment> createState() =>
      _PendingCharacterCertificateListFragmentState();
}

class _PendingCharacterCertificateListFragmentState
    extends State<PendingCharacterCertificateListFragment> {
  ...
  void _getCharacterCertList() async {
    ...
    var response = await HttpRequst.postRequestWithTokenAndBody(context,
        EndPoints.END_POINT_GET_ASSIGNED_CHARACTER_LIST_PS, data, true);
