...
class PendingFragmentCharacterEo extends StatefulWidget {
  const PendingFragmentCharacterEo({Key? key}) : super(key: key);

  @override
  State<PendingFragmentCharacterEo> createState() =>
      _PendingFragmentCharacterEoState();
}

class _PendingFragmentCharacterEoState
    extends BaseFullState<PendingFragmentCharacterEo> {
  ...
  void _getCharacterCertList() async {
    ...
    var data = {"PS_CD": userData.psCd, "SERVICE_TYPE": "1"};
                      ...
                      InkWell(
                        onTap: () {
                          if (lstData.isNotEmpty) {
                            showDownloadOption(
                                onXlsxClick: () {
                                  CsEoActionListResponse
                                      .generateExcelUnAssigned(
                                          context, lstData);
                                },
                                onPdfClick: () {});
                          }
          ...
          children: [
            Container(
              ...
              child: Row(
                children: [
                  Expanded(
                    child: Text(getTranlateString("application_serial_number"),
                        style: getHeaderStyle()),
                    flex: 1,
                  ),
                  Expanded(
                    child: Text(data.aPPLICATIONSRNUM ?? ""),
                    flex: 1,
                  )
                ],
              ),
            ...
            Container(
              ...
              child: Row(
                children: [
                  Expanded(
                    child: Text(getTranlateString("applicant_name"),
                        style: getHeaderStyle()),
                    flex: 1,
                  ),
                  Expanded(
                    child: Text(data.rEQUESTERNAME ?? ""),
                    flex: 1,
                  )
                ],
              ),
            ...
            Container(
              ...
              child: Row(
                children: [
                  Expanded(
                    child: Text(
                      getTranlateString("completed_by_constable_on"),
                      style: getHeaderStyle(),
                    ),
                    flex: 1,
                  ),
                  Expanded(
                    child: Text(data.cOMPLDT ?? ""),
                    flex: 1,
                  )
                ],
              ),
