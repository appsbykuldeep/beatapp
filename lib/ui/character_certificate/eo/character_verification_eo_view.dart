...
class CharacterVerificationEoActivity extends StatefulWidget {
  final data;

  const CharacterVerificationEoActivity({Key? key, this.data})
      : super(key: key);

  @override
  State<CharacterVerificationEoActivity> createState() =>
      _CharacterVerificationEoActivityState();
}

class _CharacterVerificationEoActivityState
    extends BaseFullState<CharacterVerificationEoActivity> {
