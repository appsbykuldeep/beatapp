...
import 'package:beatapp/ui/citizen_messages/constable/cons_citizen_messages_info_submit_view.dart';
...
class ConsPendingFragmentCitizenMessages extends StatefulWidget {
  const ConsPendingFragmentCitizenMessages({Key? key}) : super(key: key);

  @override
  State<ConsPendingFragmentCitizenMessages> createState() =>
      _ConsPendingFragmentCitizenMessagesState();
}

class _ConsPendingFragmentCitizenMessagesState
    extends BaseFullState<ConsPendingFragmentCitizenMessages> {
  ...
  void _getMessageList() async {
    ...
    var response = await HttpRequst.postRequestWithTokenAndBody(
        context, EndPoints.ASSIGNED_SHARED_INFO_LIST_TO_CONS, data, true);
    ...
    return InkWell(
      onTap: () async {
        bool res = await Navigator.push(
            context,
            MaterialPageRoute(
              builder: (context) => ConsCitizenMessagesInfoSubmitActivity(
