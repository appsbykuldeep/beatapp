...
import 'package:beatapp/ui/citizen_messages/sho/citizen_messages_assign_view.dart';
...
class UnassignedFragmentCitizenMessages extends StatefulWidget {
  const UnassignedFragmentCitizenMessages({Key? key}) : super(key: key);

  @override
  State<UnassignedFragmentCitizenMessages> createState() =>
      _UnassignedFragmentCitizenMessagesState();
}

class _UnassignedFragmentCitizenMessagesState
    extends State<UnassignedFragmentCitizenMessages> {
  List<CitizenMessage> _lstMsg = [];
  final List<CitizenMessage> _lstMsgAll = [];
  ...
  void _getMessageList() async {
    ...
    var response = await HttpRequst.postRequestWithTokenAndBody(
        context, EndPoints.END_POINT_GET_CITIZENS_MESSAGES, data, true);
    ...
    return InkWell(
      onTap: () async {
        bool result = await Navigator.push(
            context,
            MaterialPageRoute(
              builder: (context) => CitizenMessagesAssignActivity(
            ...
            Container(
              ...
              child: Row(
                children: [
                  Expanded(
                    flex: 1,
                    child: Text(getTranlateString("name_of_informer"),
                        style: getHeaderStyle()),
                  ),
                  Expanded(
                    flex: 1,
            ...
            Container(
              ...
              child: Row(
                children: [
                  Expanded(
                    flex: 1,
                    child: Text(getTranlateString("mobile_number"),
                        style: getHeaderStyle()),
                  ),
                  Expanded(
                    flex: 1,
            ...
            Container(
              ...
              child: Row(
                children: [
                  Expanded(
                    flex: 1,
                    child: Text(getTranlateString("assigned_status"),
                        style: getHeaderStyle()),
                  ),
                  Expanded(
                    flex: 1,
                    child: Text(data.ASSIGN_STATUS ?? ""),
                  )
                ],
              ),
            ),
